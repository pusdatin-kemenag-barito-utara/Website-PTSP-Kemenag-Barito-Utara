...
import { MotionDiv, fadeUpVariants, staggerContainerVariants, springPopVariants } from "@/components/common/MotionDiv";
  ...
  return (
    <div className="flex min-h-[calc(100vh-84px)] items-center justify-center p-6 sm:p-10 lg:p-12 relative overflow-hidden bg-gradient-to-br from-[#022c22] via-[#064e3b] to-[#047857]">
      ...
      >
        ...
        <MotionDiv variants={fadeUpVariants} className="mt-10 mx-auto max-w-xl text-center rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm">
