  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-600 to-indigo-700 p-8 text-white shadow-lg">
        ...
        <div className="absolute -bottom-32 left-10 h-64 w-64 rounded-full bg-indigo-500/20 blur-3xl" />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-md transition-shadow">
          ...
          <div className="flex flex-wrap gap-2">
            <Link href="/pegawai/layanan/ajukan" className="inline-flex items-center rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700">
              Ajukan Baru
            </Link>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-md transition-shadow">
          ...
          <div className="flex flex-wrap gap-2">
            <Link href="/pegawai/e-lk/isi" className="inline-flex items-center rounded-lg bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-700">
              Isi LKH Baru
            </Link>
