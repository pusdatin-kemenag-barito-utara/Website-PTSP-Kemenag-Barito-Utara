...
export function TrackResultCard({ data }: TrackResultCardProps) {
  ...
  const detailHref = data.isOwner
    ...
    : data.requestType === "asn"
      ...
      : `/login/pemohon?callbackUrl=${encodeURIComponent(`/dashboard/pengajuan/${data.id}`)}`;
    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="overflow-hidden rounded-xl bg-white border border-slate-200 shadow-sm">
        ...
        <div className="p-6 md:p-10">
          ...
          {/* ── Action Box ── */}
          <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
