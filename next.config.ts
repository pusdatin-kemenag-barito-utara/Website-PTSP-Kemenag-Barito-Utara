        ...
        headers: [
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://*.supabase.co https://*.sslip.io http://*.sslip.io https://*.googleusercontent.com https://www.gstatic.com https://www.google.com https://*.vercel-storage.com",
              "font-src 'self' https://fonts.gstatic.com",
              "frame-src 'self' https://www.google.com https://challenges.cloudflare.com https://www.youtube.com https://youtube.com blob:",
              "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://*.sslip.io http://*.sslip.io wss://*.sslip.io ws://*.sslip.io https://www.google.com https://www.gstatic.com https://cdnjs.cloudflare.com https://challenges.cloudflare.com",
