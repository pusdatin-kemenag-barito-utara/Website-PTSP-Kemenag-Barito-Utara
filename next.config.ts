        ...
        headers: [
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://*.supabase.co https://*.sslip.io:8000 http://*.sslip.io:8000 https://*.sslip.io http://*.sslip.io https://*.kemenag-baritoutara.com https://*.googleusercontent.com https://www.gstatic.com https://www.google.com https://*.vercel-storage.com",
