...
export function ServiceDetailPegawaiView({
  service,
  initialItemId,
}: {
  service: any;
          ...
          <div className="flex flex-col md:flex-row md:items-start gap-8 md:gap-10 lg:gap-16">
            ...
            <div className="flex-1 flex flex-col justify-center">
              <div className="mb-4 flex flex-wrap items-center gap-2 text-[10px] font-black uppercase tracking-widest text-emerald-400">
                ...
                <Link href="/layanan-pegawai" className="hover:text-emerald-300 transition-colors">Layanan Pegawai</Link>
              </div>
...
export default ServiceDetailPegawaiView;