                  ...
                  <div className="bg-white dark:bg-slate-900 rounded-3xl overflow-hidden shadow-2xl shadow-emerald-900/5 dark:shadow-none border border-slate-100 dark:border-slate-800 p-6 sm:p-10 transition-colors duration-300">
                    ...
                    <div className="hidden lg:block overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-xs">
                      <table className="w-full text-left border-collapse table-auto">
                        ...
                        <tbody>
                          <tr className="hover:bg-slate-50/50 dark:hover:bg-slate-800/40 transition-colors text-sm">
                            <td className="py-4 px-4 text-slate-800 dark:text-slate-100 font-bold text-center">
                              {result.name}
                            </td>
                            <td className="py-4 px-4 text-slate-700 dark:text-slate-200 font-bold text-center font-mono text-sm tracking-wide">
                              {result.nip}
                            </td>
                            <td className="py-4 px-4 text-slate-600 dark:text-slate-300 font-medium text-center text-sm">
                              {result.jabatan}
                            </td>
