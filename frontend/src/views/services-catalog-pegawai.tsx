  ...
  return (
    <main className="min-h-screen bg-slate-50/50 dark:bg-slate-950 transition-colors duration-300 pb-16">
      <PageBanner
        ...
        description="Pilih jenis layanan kepegawaian, pelajari dokumen persyaratan & SOP resmi, serta ajukan secara mandiri dan transparan."
        breadcrumb={[
          { label: "Beranda", href: "/" },
      ...
      <div className="w-full px-6 sm:px-10 lg:px-16 xl:px-20 py-8 space-y-8">
        ...
        >
          <Suspense fallback={<div className="py-20 text-center text-slate-400 dark:text-slate-500 font-medium">Memuat layanan kepegawaian...</div>}>
