...
interface PegawaiRequestConfirmationProps {
  isConfirmed: boolean;
...
export function PegawaiRequestConfirmation({
  isConfirmed,
  onConfirmChange,
  loading,
  error,
}: PegawaiRequestConfirmationProps) {
  return (
    <div className="flex flex-col gap-4 pt-2">
      ...
      >
        ...
        <div className="flex flex-col gap-1 select-none">
          ...
          >
            Saya menyatakan data & dokumen pegawai yang diisi adalah benar dan absah.
          </label>
          <p className="text-[11px] text-slate-500 dark:text-slate-400 font-medium">
            Pastikan seluruh bidang form usulan pegawai dan berkas lampiran sudah diunggah sesuai ketentuan internal ASN.
          </p>
        </div>
      </div>
      ...
      >
        ...
        {loading ? (
          ...
          <span className="flex items-center justify-center gap-2.5">
            ...
            <span className="tracking-wide">Kirim Pengajuan Pegawai</span>
          </span>
        )}
      </Button>
    </div>
