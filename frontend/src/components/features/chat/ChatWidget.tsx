...
const QUICK_ACTIONS = [
  "Syarat rekomendasi paspor haji?",
  "Cara daftar nikah online?",
  "Jam operasional PTSP?",
  "Syarat izin operasional TPQ?",
];
  ...
  const sendMessage = async (text?: string) => {
    ...
    try {
      ...
      setMessages((prev) => [
        ...
        {
          role: "assistant",
          content: "Maaf, koneksi terganggu. Silakan coba lagi sebentar lagi.",
        },
      ]);
    } finally {
      setIsLoading(false);
        ...
        {showResetConfirm && (
          ...
          >
            ...
            >
              ...
              >
                Seluruh percakapan Anda akan dihapus.
              </p>
            ...
            >
              <div
                style={{
                  maxWidth: "85%",
                  background:
                    msg.role === "user" ? "#10b981" : "rgba(255,255,255,0.07)",
                  borderRadius:
                    msg.role === "user"
                      ? "18px 18px 4px 18px"
                      : "18px 18px 18px 4px",
