...
export function RekapFilter({ initialMonth, initialYear }: { initialMonth: number, initialYear: number }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row items-center gap-2.5 bg-white dark:bg-slate-900 p-2 sm:p-2.5 rounded-3xl shadow-lg shadow-slate-200/50 dark:shadow-none border border-slate-200/80 dark:border-slate-800 w-full sm:w-auto transition-all">
