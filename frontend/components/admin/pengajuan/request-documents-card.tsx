            ...
            >
              ...
              {doc.filePath === "EXPIRED" ? (
                ...
                <a
                  ...
                  className="inline-flex shrink-0 items-center gap-2 rounded-xl px-4 py-2 text-xs font-bold text-[#059669] bg-emerald-50 border border-emerald-100 hover:bg-[#059669] hover:text-white transition-all shadow-sm active:scale-95"
                >
