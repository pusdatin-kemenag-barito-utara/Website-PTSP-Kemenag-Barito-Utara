...
const popularCategories = [
  { name: "Sub Bagian Tata Usaha", icon: Building2, query: "Tata Usaha", color: "text-amber-500", bg: "bg-amber-50" },
  { name: "Pendidikan Islam", icon: GraduationCap, query: "Pendidikan", color: "text-blue-500", bg: "bg-blue-50" },
  { name: "Bimbingan Masyarakat", icon: Users, query: "Bimbingan, Hindu", color: "text-emerald-500", bg: "bg-emerald-50" },
  { name: "Zakat & Wakaf", icon: HeartHandshake, query: "Zakat", color: "text-rose-500", bg: "bg-rose-50" },
];
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="flex-1 text-center lg:text-left space-y-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-50 border border-emerald-100 animate-in fade-in slide-in-from-bottom-4 duration-700">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.2em] text-emerald-600">Katalog Layanan Digital</span>
            </div>

            <h2 className="text-4xl md:text-6xl font-black text-slate-900 tracking-tight leading-[1.1]">
              Cari Tahu <span className="text-emerald-600">Syarat</span> <br className="hidden md:block" /> Layanan Anda
            </h2>
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 pt-4">
              <span className="text-xs font-black uppercase tracking-widest text-slate-400 mr-2">Populer:</span>
              {["Izin Operasional", "Mutasi Pegawai", "Legalisir Ijazah"].map((sugg) => (
                <Link 
                  key={sugg} 
          ...
          <div className="w-full lg:w-[480px] grid grid-cols-2 gap-4">
            {popularCategories.map((cat, idx) => {
              ...
              return (
                ...
                >
                  <div className={`mb-6 flex h-14 w-14 items-center justify-center rounded-2xl ${cat.bg} ${cat.color} group-hover:scale-110 transition-transform duration-500`}>
                  ...
                  <p className="mt-2 text-[10px] font-bold uppercase tracking-widest text-slate-400">
                    Lihat Syarat <ChevronRight className="inline h-3 w-3 ml-1 group-hover:translate-x-1 transition-transform" />
                  </p>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="text-white font-black tracking-tight">Lihat Seluruh Katalog</h4>
                  <p className="text-emerald-300/60 text-[10px] font-bold uppercase tracking-widest">30+ Jenis Layanan Tersedia</p>
                </div>
              </div>
