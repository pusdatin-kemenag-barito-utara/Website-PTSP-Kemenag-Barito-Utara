  ...
  const videos = [
    {
      ...
      description: "Gambaran singkat fasilitas pelayanan terpadu satu pintu, sistem operasional, dan alur pelayanan resmi.",
    },
    {
      id: "HcUDLmVKfgQ",
      title: "Kegiatan & Ucapan Keagamaan",
      description: "Dokumentasi kegiatan hari besar keagamaan dan ucapan resmi Kantor Kementerian Agama Barito Utara.",
    },
  ];
      ...
      <div className="mx-auto w-full px-6 sm:px-10 lg:px-16 xl:px-24 relative z-10">
        ...
        <div className="mb-20 text-center max-w-3xl mx-auto space-y-4">
          ...
          <p className="text-sm sm:text-base text-slate-500 font-semibold max-w-2xl mx-auto leading-relaxed">
            Saksikan video profil pelayanan terpadu serta dokumentasi kegiatan resmi di lingkungan Kantor Kementerian Agama Kabupaten Barito Utara.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16 max-w-6xl mx-auto">
          {videos.map((vid, idx) => (
            <div key={vid.id} className="relative group flex flex-col space-y-6">
